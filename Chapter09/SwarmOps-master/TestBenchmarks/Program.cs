...
namespace TestBenchmarks
{
    ...
    /// </summary>
    [BenchmarkDotNet.Attributes.Jobs.ClrJob(isBaseline: true), BenchmarkDotNet.Attributes.Jobs.CoreJob]
    [BenchmarkDotNet.Attributes.Columns.RankColumn, BenchmarkDotNet.Attributes.CsvMeasurementsExporter()]
    class Program
    {
