...
public class AutoencoderLearningRate
{
    ...
    internal List<double> preLearningRateBiases = new ();
    /// <summary>   The pre learning rate weights. </summary>
    internal List<double> preLearningRateWeights = new ();
    /// <summary>   The pre momentum biases. </summary>
    internal List<double> preMomentumBiases = new ();
    /// <summary>   The pre momentum weights. </summary>
    internal List<double> preMomentumWeights = new ();
    /// <summary>   The fine learning rate biases. </summary>
    internal List<double> fineLearningRateBiases = new ();
    /// <summary>   The fine learning rate weights. </summary>
    internal List<double> fineLearningRateWeights = new ();
    #endregion
