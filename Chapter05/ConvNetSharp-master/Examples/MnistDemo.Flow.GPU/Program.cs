...
{
    private readonly CircularBuffer<double> _testAccWindow = new (100);
    private readonly CircularBuffer<double> _trainAccWindow = new (100);
    ...
    {
        BuilderInstance<float>.Volume 
            = new ConvNetSharp.Volume.GPU.Single.VolumeBuilder();
