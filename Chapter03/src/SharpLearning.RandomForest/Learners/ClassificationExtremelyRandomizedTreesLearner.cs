...
namespace SharpLearning.RandomForest.Learners
{
        ...
        ILearner<double>, ILearner<ProbabilityPrediction>
    {
        ...
        double[] VariableImportance(ClassificationDecisionTreeModel[] models, int numberOfFeatures)
        {
            ...
            foreach (var modelVariableImportance in models.Select(model => model.GetRawVariableImportance()))
            {
        ...
        {
            var learner = new DecisionTreeLearner(new DepthFirstTreeBuilder(m_maximumTreeDepth,
                    m_featuresPrSplit, m_minimumInformationGain, m_random.Next(),
            ...
            return new ClassificationDecisionTreeModel(learner.Learn(observations, targets, treeIndices));
        }
    }
}
