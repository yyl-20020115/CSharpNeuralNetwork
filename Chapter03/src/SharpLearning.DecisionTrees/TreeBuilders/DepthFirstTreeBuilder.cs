...
namespace SharpLearning.DecisionTrees.TreeBuilders
{
    ...
    public sealed class DepthFirstTreeBuilder : ITreeBuilder
    {
            ...
            ISplitSearcher splitSearcher, IImpurityCalculator impurityCalculator)
        {
            ...
            m_splitSearcher = splitSearcher ?? throw new ArgumentException("splitSearcher");
            m_impurityCalculator = impurityCalculator ?? throw new ArgumentException("impurityCalculator");
