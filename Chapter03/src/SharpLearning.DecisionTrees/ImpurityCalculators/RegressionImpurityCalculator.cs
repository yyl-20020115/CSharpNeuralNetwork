...
namespace SharpLearning.DecisionTrees.ImpurityCalculators
{
    ...
    public sealed class RegressionImpurityCalculator : IImpurityCalculator
    {
        ...
        {
            m_targets = targets ?? throw new ArgumentException("targets");
            m_weights = weights ?? throw new ArgumentException("weights");
            m_interval = interval;
        ...
        public void Reset()
        {
            ...
            m_varRight = (m_sqSumRight / m_weightedTotal - m_meanRight * m_meanRight);
            m_varLeft = 0.0;
        ...
        public void UpdateIndex(int newPosition)
        {
            ...
            m_varLeft = (m_sqSumLeft / m_weightedLeft - m_meanLeft * m_meanLeft);
            m_varRight = (m_sqSumRight / m_weightedRight - m_meanRight * m_meanRight);
        ...
        {
            return (m_sqSumTotal / m_weightedTotal - m_meanTotal * m_meanTotal);
        }
        ...
        {
            var diff = ((m_sumLeft / m_weightedLeft) - (m_sumRight / m_weightedRight));
            return (m_weightedLeft * m_weightedRight * diff * diff / (m_weightedLeft + m_weightedRight));
        }
