...
namespace SharpLearning.DecisionTrees.Nodes
{
    ...
    public sealed class BinaryTree
    {
        ...
        {
            Nodes = nodes ?? throw new ArgumentNullException("nodes");
            Probabilities = probabilities ?? throw new ArgumentNullException("probabilities");
            TargetNames = targetNames ?? throw new ArgumentNullException("targetNames");
            VariableImportance = variableImportance ?? throw new ArgumentNullException("variableImportance");
        }
