...
namespace SharpLearning.Ensemble.Models
{
    ...
    public class RegressionEnsembleModel : IPredictorModel<double>
    {
        ...
        {
            m_ensembleModels = ensembleModels ?? throw new ArgumentNullException("ensembleModels");
        ...
        public Dictionary<string, double> GetVariableImportance(Dictionary<string, int> featureNameToIndex)
        {
            ...
            foreach (var importance in m_ensembleModels.Select(model => model.GetVariableImportance(featureNameToIndex)).SelectMany(modelImportances => modelImportances))
            {
