...
namespace SharpLearning.Ensemble.Models
{
    ...
    public class RegressionStackingEnsembleModel : IPredictorModel<double>
    {
        ...
        {
            m_ensembleModels = ensembleModels ?? throw new ArgumentException("ensembleModels");
            m_metaModel = metaModel ?? throw new ArgumentException("metaModel");
        ...
        public Dictionary<string, double> GetVariableImportance(Dictionary<string, int> featureNameToIndex)
        {
            ...
            foreach (var name in m_ensembleModels.Select(model => model.GetType().Name))
            {
